...
namespace OSFUI
{
	...
	inline constexpr const char* kPluginVersion = "1.5.0";
	...
	inline constexpr std::uint32_t kPluginVersionMinor = 5;
	...
	inline constexpr const char* kBridgeProtocolVersion = "1.6";
