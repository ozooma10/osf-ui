...
namespace OSFUI
{
	...
	inline constexpr const char* kPluginVersion = "1.3.0";
	...
	inline constexpr std::uint32_t kPluginVersionMinor = 3;
	...
	inline constexpr const char* kBridgeProtocolVersion = "1.4";
