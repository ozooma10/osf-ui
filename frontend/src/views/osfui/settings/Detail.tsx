...
// this subtree. Modes 2 and 4 clear it, so one mod's colour cannot leak onto
// the launcher or onto a mod that ships none. Modes 1 and 3
...
export interface DetailProps {
  ...
  labeler?: KeyLabeler;
  /** Complete, unfiltered `osfui/views` catalog for view status. */
...
export function Detail(props: DetailProps) {
  ...
  const entry =
    query || selectedId === HOME_ID ? undefined : findEntry(mods, views, selectedId);
