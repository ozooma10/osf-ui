...
// mock has settled; a classic entry runs earlier but its commands wait in the
// bootstrap's outbound queue. Either way the mock never misses a command.
//
...
try {
  ...
  // The runtime itself failed — surface it and boot the view bare so the page
  // never white-screens.
