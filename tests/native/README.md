...
| `scaleform_overlay_hook_policy_tests.cpp` | `composite/ScaleformOverlayHookPolicy`: fail-closed recognition of Scaleform-pass slot owners (vanilla plus the proven foreign hooks) gating overlay-hook installation |
